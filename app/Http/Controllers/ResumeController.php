...
class ResumeController extends Controller
{
    public function view(User   $user){
        ...
        return view('resume.view', compact('resume', 'user'));
    }
    ...
    public function dataAdd(Request $request)
    {
        ...
        if ($request->type == 'edu') {
            ...
            $file->file = $request->file->store('uploads/resume');
            $file->save();
            $data = view('resume.partial.file.single',['file'=>$file])->render();
    ...
    public function dataDel(Request $request)
    {
        ...
        if ($request->type == 'edu') {
            ...
            $file = ResumeFile::where('id', $request->id)->first();
            $file->delete();
