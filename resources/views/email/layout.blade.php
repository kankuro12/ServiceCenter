                                    ...
                                    <div style="width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <div align="right" class="button-container"
                                                ...
                                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 0px; padding-bottom: 10px; padding-left: 10px" align="right"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:31.5pt; width:112.5pt; v-text-anchor:middle;" arcsize="34%" stroke="false" fillcolor="#e3edfe"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#052d3d; font-family:Tahoma, Verdana, sans-serif; font-size:14px"><![endif]--><a
                                                    href="{{url('my-profile')}}"
                                    ...
                                    <div style="width:100% !important;">
                                        ...
                                        <div
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 15px; padding-left: 0;"
                                                                            valign="top"><a
                                                                                ...
                                                                                target="_blank"><img alt="Facebook"
                                                                                    height="32"
                                                                                    src="{{url('mail/images/facebook2x.png')}}"
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 15px; padding-left: 0;"
                                                                            valign="top"><a href="https://twitter.com/"
                                                                                target="_blank"><img alt="Twitter"
                                                                                    height="32"
                                                                                    src="{{url('mail/images/twitter2x.png')}}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;"
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 15px; padding-left: 0;"
                                                                            valign="top"><a
                                                                                ...
                                                                                target="_blank"><img alt="Instagram"
                                                                                    height="32"
                                                                                    src="{{url('mail/images/instagram2x.png')}}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;"
                                                                        ...
                                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 15px; padding-left: 0;"
                                                                            valign="top"><a
                                                                                ...
                                                                                target="_blank"><img alt="Pinterest"
                                                                                    height="32"
                                                                                    src="{{url('mail/images/pinterest2x.png')}}"
                                                                                    style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    style="font-size: 12px; line-height: 1.5; color: #555555; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px;">
                                                    <p
                                                        style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                        Luga Sansar - some slogan and it is this long</p>
                                                    <p
                                                        style="font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin: 0;">
                                                        munalpath biratnagar </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            <table border="0" cellpadding="0" cellspacing="0" class="divider"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    style="font-size: 12px; line-height: 1.2; color: #4F4F4F; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14px;">
                                                    <p
                                                        style="font-size: 14px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">
                                                        <span style="font-size: 14px;"><a href="{{url('about-us')}}"
                                                                rel="noopener"
                                                                style="text-decoration: none; color: #2190E3;"
                                                                target="_blank"><strong>About&amp; Us</strong></a> | 
                                                              <span
                                                                style="background-color: transparent; font-size: 14px;">977-9800916365</span></span>
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
