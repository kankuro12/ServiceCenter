...
@section('title','Pending Order Detail')
@section('content')
                ...
                <div class="card card-fluid" style="margin-top:1rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <dl class="row">
                                    ...
                                    <dt class="col-md-6">Customer Address :-</dt>
                                    <dd class="col-md-6"> {{ $orderDetail[0]->order->address }},
                                        {{ $orderDetail[0]->order->city }}, {{ $orderDetail[0]->order->district }} </dd>
                        ...
                        <table class="table table-bordered ">
                            ...
                            <tr>
                                <td> {{ $key+1 }} </td>
                                <td><img src="{{ asset('back/images/product/'.$item->product->feature_image) }}"
                                ...
                                <td>
                                    ...
                                    @else
                                    <p>Color :- <strong>{{ $item->color_name }}</strong> | Size :-
                        ...
                        <form action="{{ url('dashboard/response-message') }}" method="POST">
                            @csrf
                            @php
                            $message = \App\Responsemessage::where('order_id',$orderDetail[0]->order->id)->first();
                            @endphp
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="hidden" name="order_id" value="{{ $orderDetail[0]->order->id }}">
                            ...
                            <hr>
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block">Response Now !</button>
                            </div>
                        </form>
                    </div><!-- /.card-body -->
                </div>
