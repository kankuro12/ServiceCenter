                            ...
                            <div class="row">
                                <div class="col-md-5">
                                        <dl class="row">
                                                ...
                                                <dt class="col-md-6">Product Attributes :</dt>
                                                <dd class="col-md-6">
                                                    @if ($product->type==0)
                                                        <span class="badge badge-danger">No Attributes</span>
                                                    @else
                                                        @foreach(\App\Stock::where('product_id',$product->id)->get() as $attr)
                                                            <span class="badge badge-info">{{ $attr->color->name }} ({{ $attr->color->shortcode }}) -> {{ $attr->size->name }} ({{ $attr->size->shortcode }}) (Qty.{{ $attr->total}})</span>
                                                        @endforeach
                                                    @endif
                                                </dd>
