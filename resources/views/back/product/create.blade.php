    ...
    <div class="wrapper">
        ...
        <div class="page">
                        ...
                        <form action="{{ Route('product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" {{ old('name')}} name="title"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_detail" rows="3" class="form-control"
                                    placeholder="Enter Short Detail About Product">{{ old('short_detail')}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="title">Detail <span style="color:red;">*</span></label>
                                <textarea name="detail" rows="6" class="form-control"
                                    placeholder="Enter Full Detail About Product">{{ old('detail')}}</textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" {{ old('price')}} name="price"
                                            placeholder="Enter Product Price" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="sales_price"> Product Sale Price <span
                                                style="color:red;">*</span></label>
                                        <input type="number" {{ old('sales_price')}} name="sales_price"
                                            placeholder="Enter Product Sales Price" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="code"> Product Code <span style="color:red;">*</span></label>
                                        <input type="text" {{ old('code')}} name="code" placeholder="Enter Product Code"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" {{ old('tag')}} name="tag"
                                    placeholder="Enter Product Tags Separated by (,)" class="form-control" required>
                            </div>
                            <hr>
                            {{-- <div style="border:1px #30619F solid; padding:1rem;" id="attrSection">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h6> Color :- <strong>{{ $color->name }} ({{ $color->shortcode }})</strong>
                            </h6>
                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" min="0" value="0" class="form-control" name="total[]"
                                        placeholder="Enter stock keeping unit" style="width:200px;">
                                </div>
                            </div>
                            <br>
                            @endforeach
            ...
            <div class="text-center">
                ...
                <div class="form-group">
                    <img src="" id="photo"
                        style="border:1.5px #30619F solid; padding:10px; height:450px; margin-bottom:12px;">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <label class="switcher-control switcher-control-lg"><input type="checkbox"
                                    class="switcher-input" value='1' name="onsale"> <span
                                    class="switcher-indicator"></span> <span class="switcher-label-on">ON</span> <span
                                    class="switcher-label-off">OFF</span></label>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <span>Product Promo Item</span>
                            <label class="switcher-control switcher-control-lg"><input type="checkbox"
                                    class="switcher-input" value='1' name="promo"> <span
                                    class="switcher-indicator"></span> <span class="switcher-label-on">ON</span> <span
                                    class="switcher-label-off">OFF</span></label>
                        </div>
                    </div>
