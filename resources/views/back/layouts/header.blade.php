      ...
      <div class="aside-menu overflow-hidden">
        ...
        <nav id="stacked-menu" class="stacked-menu">
          ...
          <ul class="menu">
            ...
            <li class="menu-item has-child">
                <a href="#" class="menu-link"><span class="menu-icon oi oi-puzzle-piece"></span> <span class="menu-text">Services</span></a> <!-- child menu -->
                <ul class="menu">
                  <li class="menu-item <?php if(preg_match('/service/i',$url)){ echo'has-active';}?>">
                      <a href="{{ route('service.index') }}" class="menu-link">Service</a>
                  </li>
                  <li class="menu-item <?php if(preg_match('/service-item/i',$url)){ echo'has-active';}?>">
                    <a href="{{ route('service.item.index') }}" class="menu-link">Service Iitem</a>
                  </li>
                </ul>
              </li>
            ...
            {{-- <li class="menu-item has-child">
                ...
                <ul class="menu">
                  ...
                  <li class="menu-item">
                    <a href="{{ url('dashboard/footer-header') }}" class="menu-link">Footer Head</a>
                  </li>
                  <li class="menu-item">
