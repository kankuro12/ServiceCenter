                        ...
                        <div class="card-body">
                                <form action="{{ url('dashboard/popup-info')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <label class="switcher-control switcher-control-lg"><input type="checkbox" name="status" class="switcher-input" {{ $pop->status?'checked':'' }}> <span class="switcher-indicator"></span> <span class="switcher-label-on">ON</span> <span class="switcher-label-off">OFF</span></label> <!-- /.switcher-control -->
                                    </div>
                                    <hr>
