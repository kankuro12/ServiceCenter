                                ...
                                {{-- <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="{{asset('front/images/products/cart/product-2.jpg') }}"
                                alt="product">
                                </a>
                                </figure>
                        ...
                        <nav class="side-nav">
                            ...
                            <ul class="menu-vertical sf-arrows">
                                <li class="megamenu-container">
                                    ...
                                    <a class="sf-with-ul"
                                        href="{{ url('shops?cat%5B%5D='.$attr->id) }}">{{ $attr->name }}</a>
                                    <div class="megamenu">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="menu-title"><a
                                                                    href="{{ url('shops?cat%5B%5D='.$item->id) }}">
                                                                    {{ $item->name }} </a></div><!-- End .menu-title -->
                                                            @if (count($item->subcat))
                                                            @foreach ($item->subcat as $item1)
                                                            <ul>
                                                                <li><a
                                                                        href="{{ url('shops?cat%5B%5D='.$item1->id) }}"><strong>{{ $item1->name }}</strong></a>
                                                                </li>
                                                            </ul>
                                                            @endforeach
                                                            @endif
                                            ...
                                            <div class="col-md-4">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html" class="banner banner-menu">
                                                        <img src="{{asset('front/images/demos/demo-13/menu/banner-2.jpg') }}"
                                                            alt="Banner">
                                                    </a>
                                    ...
                                    @endif
                                    @if (count($attr->subcat) == 0)
                                    <a href="{{ url('shops?cat%5B%5D='.$attr->id) }}">{{ $attr->name }}</a>
                                    @endif
                                </li>
                            </ul>
                            @endforeach
