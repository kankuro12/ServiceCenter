            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="icon-box icon-box-side">
                        ...
                        <div class="icon-box-content">
                            <h3 class="icon-box-title">{{ $footer_info->col_1 }}</h3><!-- End .icon-box-title -->
                            <p>{{ $footer_info->item_1 }}</p>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="icon-box icon-box-side">
                        ...
                        <div class="icon-box-content">
                            <h3 class="icon-box-title">{{ $footer_info->col_2 }}</h3><!-- End .icon-box-title -->
                            <p>{{ $footer_info->item_2 }}</p>
                        </div><!-- End .icon-box-content -->
                    </div><!-- End .icon-box -->
                </div><!-- End .col-sm-6 col-lg-3 -->
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="icon-box icon-box-side">
                        ...
                        <div class="icon-box-content">
                            <h3 class="icon-box-title">{{ $footer_info->col_3 }}</h3><!-- End .icon-box-title -->
                            <p>{{ $footer_info->item_3 }}</p>
                        </div><!-- End .icon-box-content -->
                    </div><!-- End .icon-box -->
                </div><!-- End .col-sm-6 col-lg-3 -->
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="icon-box icon-box-side">
                        ...
                        <div class="icon-box-content">
                            <h3 class="icon-box-title">{{ $footer_info->col_4 }}</h3><!-- End .icon-box-title -->
                            <p>{{ $footer_info->item_4 }}</p>
                        </div><!-- End .icon-box-content -->
                    </div><!-- End .icon-box -->
                </div><!-- End .col-sm-6 col-lg-3 -->
            </div><!-- End .row -->
