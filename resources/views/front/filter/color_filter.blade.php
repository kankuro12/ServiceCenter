    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav" style="margin-bottom: 0rem;" >
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Filter Items</li>
                <li class="breadcrumb-item active" aria-current="page">@if(!empty($color)) {{ $color->name }} @endif</li>
                <li class="breadcrumb-item active" aria-current="page">@if(!empty($size)) {{ $size->name }} @endif</li>
            </ol>
        </div><!-- End .container -->
                                ...
                                <div class="col-6 col-lg-3 order-lg-last">
                                    <div class="product-list-action">
                                        ...
                                        <div class="product-action">
                                           <a href="{{ url('add-to-withlist',$p->id) }}" class="btn-product btn-wishlist text-white" title="Add to wishlist" style="background: #E88C36; padding:3px;"><span>add to wishlist</span></a>
                ...
                <aside class="col-lg-3 order-lg-first" style="margin-top: 18px;">
                    <div class="sidebar sidebar-shop">
                        ...
                        @foreach(\App\Color::all() as $color)
                            <div class="widget widget-collapsible">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="#widget-color-{{$color->id}}" role="button" aria-expanded="true" aria-controls="widget-color-{{$color->id}}">
                                        Product Color : <strong>{{ $color->name }} ({{ $color->shortcode }})</strong>
                                    </a>
                                </h3><!-- End .widget-title -->
                                <div class="collapse show" id="widget-color-{{$color->id}}">
                                    <div class="widget-body">
                                        <div class="filter-items">
                                            ...
                                            <form action="{{ url('color-filter') }}" method="POST">
                                                ...
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="size_id" onchange="javascript:this.form.submit();" value="{{ $item->id }}"  class="custom-control-input" id="size-{{ $item->id }}"
                                                        @if(!empty($size))
                                                          {{ $size->id == $item->id ? 'checked':'' }}
                                                        @endif
                                                        >
