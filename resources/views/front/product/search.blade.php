                ...
                <div class="col-lg-9">
                    ...
                    <div class="products mb-3">
                        ...
                        <form action="{{ url('add-to-cart') }}" method="POST">
                            ...
                            @if ($p->type == 1)
                                <input type="hidden" name="price" value="" id="modifyPrice">
                            @else
