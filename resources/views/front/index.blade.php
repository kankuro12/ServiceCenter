...
<main class="main">
        ...
        <div class="cat-blocks-container">
            <div class="row">
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="{{ url('shops?brand%5B%5D='.$brand->id)}}" class="cat-block">
                        <figure>
                            <span>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="banner banner-overlay">
                    ...
                    <div class="banner-content">
                        <h4 class="banner-subtitle text-white"><a href="#">{{ $top_left->sub_title }}</a></h4>
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white"><a href="#">{!! $top_left->title !!}</a></h3>
                        <!-- End .banner-title -->
                        @if($top_left->link == null)
                        <a href="{{ url('shops') }}" class="banner-link">{{ $top_left->button_name }} <i
                                class="icon-long-arrow-right"></i></a>
                        @else
                        <a href="{{ $top_left->link }}" class="banner-link">{{ $top_left->button_name }} <i
                                class="icon-long-arrow-right"></i></a>
                        @endif
            ...
            <div class="col-sm-6 col-lg-3 order-lg-last">
                <div class="banner banner-overlay">
                    ...
                    <div class="banner-content">
                        <h4 class="banner-subtitle text-white"><a href="#">{{ $top_right->sub_title }}</a></h4>
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white"><a href="#">{!! $top_right->title !!}</a></h3>
                        <!-- End .banner-title -->
                        @if($top_right->link == null)
                        <a href="{{ url('shops') }}" class="banner-link">{{ $top_right->button_name }} <i
                                class="icon-long-arrow-right"></i></a>
                        @else
                        <a href="{{ $top_right->link }}" class="banner-link">{{ $top_right->button_name }} <i
                                class="icon-long-arrow-right"></i></a>
                        @endif
                    </div><!-- End .banner-content -->
                </div><!-- End .banner -->
                ...
                <div class="banner banner-overlay">
                    ...
                    <div class="banner-content">
                        <h4 class="banner-subtitle text-white d-none d-sm-block"><a
                                href="#">{{ $top_middle->sub_title }}</a></h4><!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white"><a href="#">{!! $top_middle->title !!}</a></h3>
                        <!-- End .banner-title -->
                        @if($top_middle->link == null)
                        <a href="{{ url('shops') }}" class="banner-link">{{ $top_middle->button_name }} <i
                                class="icon-long-arrow-right"></i></a>
                        @else
                        <a href="{{ $top_middle->link }}" class="banner-link">{{ $top_middle->button_name }} <i
                                class="icon-long-arrow-right"></i></a>
                        @endif
                    </div><!-- End .banner-content -->
                </div><!-- End .banner -->
    ...
    <div class="bg-light pt-3 pb-5">
        <div class="container">
            <div class="heading heading-flex heading-border mb-3">
                ...
                <div class="heading-right">
                    <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="hot-{{ $item->id }}-link" data-toggle="tab"
                                href="#hot-{{ $item->id }}-tab" role="tab" aria-controls="hot-{{ $item->id }}-tab"
            ...
            <div class="tab-content tab-content-carousel">
                                ...
                                <figure class="product-media">
                                    @if ($item->sales_price < $item->price)
                                        ...
                                        @if ($current_date < $item->newProduct())
                                            ...
                                            @endif
                                            <a href="#">
                                                <img src="{{asset('back/images/product/'.$item->feature_image) }}"
                                            ...
                                            <div class="product-action-vertical">
                                                @if(empty(Auth::check()))
                                                <span
                                                    class="btn-product-icon btn-wishlist"><sup>{{ $item->withlistCount() }}</sup></span>
                                                @else
                                                @if($item->withlistProductId() == $item->id)
                                                <span class="btn-product-icon btn-wishlist text-white"
                                                    style="background-color: #39f;"><sup>{{ $item->withlistCount() }}</sup></span>
                                                @else
                                                <span
                                                    class="btn-product-icon btn-wishlist"><sup>{{ $item->withlistCount() }}</sup></span>
                                                @endif
                                            ...
                                            <div class="product-action"
                                                style="border: 0.1rem solid #FCB941; margin-bottom: 0.6rem; background-color: #FCB941;">
                                                @if ($item->type == 0)
                                                @php
                                                ...
                                                <button class="btn-product btn-cart text-white" title="Add to cart"
                                                    style="border: 0;"><span class="text-white">add to
                                                        cart</span></button>
                                                @else
                                                ...
                                                <a href="{{ url('/product/detail/'.$item->id) }}"
                                                    class="btn-product btn-cart text-white" title="View Detail"><span
                                                        class="text-white">View Detail</span></a>
                                                @endif
                ...
                <div class="tab-pane p-0 fade" id="hot-{{ $category[0]->id }}-tab" role="tabpanel"
                    aria-labelledby="hot-{{ $category[0]->id }}-link">
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        data-owl-options='{
                                "nav": false,
                                "dots": true,
                ...
                <div class="tab-pane p-0 fade" id="hot-{{ $category[1]->id }}-tab" role="tabpanel"
                    aria-labelledby="hot-{{ $category[1]->id }}-link">
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        data-owl-options='{
                                "nav": false,
                                "dots": true,
                                    ...
                                    @if ($item->sales_price < $item->price)
                                        ...
                                        @if ($current_date < $item->newProduct())
                                            ...
                                            <div class="product-action"
                                                ...
                                                @else
                                                <a href="{{ url('/product/detail/'.$item->id) }}"
                                                    class="btn-product btn-cart text-white" title="Add to cart"><span
                                                        class="text-white">View Detail</span></a>
                                                @endif
                                            </div><!-- End .product-action -->
                                </figure><!-- End .product-media -->
                ...
                <div class="tab-pane p-0 fade" id="hot-{{ $category[2]->id }}-tab" role="tabpanel"
                    aria-labelledby="hot-{{ $category[2]->id }}-link">
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        data-owl-options='{
                                "nav": false,
                                "dots": true,
                ...
                <div class="tab-pane p-0 fade" id="hot-{{ $category[3]->id }}-tab" role="tabpanel"
                    aria-labelledby="hot-{{ $category[3]->id }}-link">
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        data-owl-options='{
                                "nav": false,
                                "dots": true,
                ...
                <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="clot-featured-link" data-toggle="tab" href="#clot-featured-tab"
                            role="tab" aria-controls="clot-featured-tab" aria-selected="false">Most Like</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="product">
                            <figure class="product-media">
                                @if ($item->product->sales_price < $item->product->price)
                                    ...
                                    @if ($current_date < $item->product->newProduct())
                                        ...
                                        @endif
                                        <a href="#">
                                            <img src="{{asset('back/images/product/'.$item->product->feature_image) }}"
                                                alt="Product image" class="product-image">
                                        </a>

                                        <div class="product-action-vertical">
                                            <span
                                                class="btn-product-icon btn-wishlist"><sup>{{ $item->product->withlistCount() }}</sup></span>
                                        </div><!-- End .product-action-vertical -->
                                        ...
                                        <div class="product-action"
                                            ...
                                            @php
                                            $stockCount =
                                            \App\Simplestock::where('product_id',$item->product->id)->count();
                                            $stockCheck =
                                            \App\Simplestock::where('product_id',$item->product->id)->first();
                                            @endphp
                                            @if ($stockCount>0)
                                            @if($stockCheck->total>0)
                                            <button class="btn-product btn-cart text-white" title="Add to cart"
                                                style="border: 0;"><span class="text-white">add to cart</span></button>
                                            @else
                                            <button disabled="disabled" class="btn btn-danger">Out Of Stock</button>
                                            @endif
                                            @else
                            ...
                            <div class="product-body">
                                ...
                                <div class="product-price">
                                    ...
                                    @if ($item->product->sales_price < $item->product->price)
                                        <span class="font-weight-light line-through">
                                            NPR.{{ $item->product->price }}</span>
                                        @endif
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                                    <div class="ratings">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="banner banner-overlay banner-overlay-light">
                    ...
                    <div class="banner-content">
                        <h4 class="banner-subtitle d-none d-sm-block"><a href="#">{{ $bottom_left->sub_title }}</a></h4>
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title"><a href="#">{!! $bottom_left->title !!}</a></h3>
                        <!-- End .banner-title -->
                        @if($top_left->link == null)
                        <a href="{{ url('shops') }}"
                            class="banner-link banner-link-dark">{{ $bottom_left->button_name }} <i
                                class="icon-long-arrow-right"></i></a>
                        @else
                        <a href="{{ $bottom_left->link }}"
                            class="banner-link banner-link-dark">{{ $bottom_left->button_name }}<i
                                class="icon-long-arrow-right"></i></a>
                        @endif
                    </div><!-- End .banner-content -->
            ...
            <div class="col-lg-6">
                <div class="banner banner-overlay">
                    ...
                    <div class="banner-content">
                        <h4 class="banner-subtitle text-white  d-none d-sm-block"><a
                                href="#">{{ $bottom_right->sub_title }}</a></h4><!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white"><a href="#">{!! $bottom_right->title !!}</a></h3>
                        <!-- End .banner-title -->
                        @if($bottom_right->link == null)
                        <a href="{{ url('shops') }}"
                            class="banner-link banner-link-dark">{{ $bottom_right->button_name }} <i
                                class="icon-long-arrow-right"></i></a>
                        @else
                        <a href="{{ $bottom_right->link }}"
                            class="banner-link banner-link-dark">{{ $bottom_right->button_name }}<i
                                class="icon-long-arrow-right"></i></a>
                        @endif
                    </div><!-- End .banner-content -->
    ...
    <div class="cta cta-horizontal cta-horizontal-box" style="background-color: #E88C36;">
        <div class="container">
                    ...
                    <form action="javascript:void(0);" type="post">
                        ...
                        <div class="successMessage">
                            <div class="input-group">
                                <input type="email" onfocus="actionFunction();" name="email"
                                    class="form-control form-control-white newsletterEmail"
                                    placeholder="Enter your Email Address" aria-label="Email Adress" required>
                                <div class="input-group-append">
                                    <button class="btn btn-outline-white-2 buttonNewsletter" onclick="addEmail();"
            ...
            <div class="row no-gutters bg-white newsletter-popup-content">
                <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                    <div class="banner-content text-center">
                        <img src="{{asset('front/images/info/'.$basic_info->logo) }}" class="logo" alt="logo" width="60"
                            height="15">
