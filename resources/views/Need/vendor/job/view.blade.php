...
<div class="bg-white shadow mb-4">
    ...
    <div class="line"></div> --}}
        <div class="view-on" id="detail-holder" >
            <form action="{{ route('n.front.vendor.posted-job.update',['job'=>$job->id]) }}" id="update-job-form" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row ">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            ...
                            <select  name="job_category_id" id="job_category_id"
                                ...
                                @foreach ($cats as $cat)
                                    <option value="{{$cat->id}}" {{$cat->id==$job->job_category_id?'selected':''}}>{{$cat->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
