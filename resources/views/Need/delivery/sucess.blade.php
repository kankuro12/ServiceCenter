...
@section('content')
    <div class="success">
        <div class="title">
              You Delivery List Has Been Uploaded Sucessfully.
            ...
            <div class="row px-2 px-md-4">
                    ...
                    <div class="bg-white py-3">
                        ...
                        <p class="text-center normal">
                            <span class="min-title ">
                                Your References ID For Delivery List IS : #000{{$id}}
                            </span>
                ...
                <div class="col-md-6  py-2">
                    <div class="bg-white py-3">
                        ...
                        <p class="text-center normal">
                            <span class="min-title ">
                                You Can View Your Delivery List Any Time Using User Panel.
                            </span>
